...
import {
  Activity, AlertTriangle, ArrowRight, Award, Banknote, BarChart, BarChart3, Bell, BookOpen, BookText,
  Building2, Calendar, CalendarClock, Check, CheckCircle2, CheckSquare, ChevronDown, ChevronLeft,
  ChevronRight, CircleHelp, ClipboardCheck, ClipboardList, Clock, ClockAlert, CreditCard,
  Eye, EyeOff, Facebook, FileCheck, FileText, Film, Flag, FolderTree, Gauge, GitBranch,
  GraduationCap, Heart, HelpCircle, History, Home, IdCard, Instagram, LayoutDashboard, LifeBuoy,
  LineChart, Linkedin, ListChecks, Mail, Map, MapPin, Megaphone, Menu, MessageCircle, MessageSquare,
  Pause, Phone, PieChart, Play, Plus, PlusCircle, Quote, RotateCcw, Rss, Save, ScrollText, Search,
  Settings, Shield, Sliders, Sparkles, Star, Table2, Target, TicketPercent, Trophy, Twitter,
  Upload, User, UserPlus, Users, Users2, Wallet, X, Youtube,
} from 'lucide-react';
